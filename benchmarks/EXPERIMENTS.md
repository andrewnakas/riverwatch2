...
| 4 | 07-02 | P2 forcing A/Bs | ens4ft str3: gefs / ecmwf / ecmwf+hrrr? / gefs+hrrr? vs gfs ref | +0.015 NSE str3 → full confirm +0.01, no tercile regression; else kill product swaps | **ECMWF 0.5499 (+0.040); GEFS-mean 0.5173 (+0.008, below screen); HRRR overlay hurts everywhere (ECMWF+HRRR 0.5405)** | **ECMWF wins on model quality** (not smoothing — GEFS-mean gain is small). HRRR overlay killed permanently. Full-scale ECMWF confirmation armed; serve-side RW2_FCST_MODEL=ecmwf_ifs025 staged on it. P3 mix amended to perfect:.25/gfs:.3/gefs:.25/ecmwf:.2 |
