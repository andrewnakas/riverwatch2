...
case "$M" in
  ...
  fused3h1sel) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 0.5 --select-by nse" ;;
  fused3h1w03) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 0.3" ;;
  fused3h1w07) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 0.7" ;;
  fused3h1w08) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 0.8" ;;
  fused3h1w09) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 0.9" ;;
  fused3h1w10) CORP="gpu1080/corpora671/camels_corpus_fused_v2_531"; ENC="camels3fv2"; EXTRA="--h1-weight 1.0" ;;
